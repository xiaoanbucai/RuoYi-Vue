<template>
  ...
  <div class="hello">
        
    <div ref="mapbox" style="width: 1000px; height: 480px; margin: 0 auto"></div>
        <!-- 初始化echarts需要有个宽高的盒子 -->
      
  </div>
</template>
...
const option = {
  title: {
    // 标题内容
    text: "全国疫情地图",
    link: "https://voice.baidu.com/act/newpneumonia/newpneumonia#tab0",
    subtext: "点击查看详细情况",
    sublink: "https://voice.baidu.com/act/newpneumonia/newpneumonia#tab0",
  },
  series: [
    {
      name: "确诊人数",
      ...
      jsonp(
        ...
        (err, data) => {
          if (!err) {
            ...
            this.mycharts.setOption(option); // echarts初始化的前提是dom渲染完成
          }
        }
      );
    },
